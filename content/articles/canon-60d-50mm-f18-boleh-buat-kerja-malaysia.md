...
## Kebenaran tentang 60D yang orang lupa

| Spes | Canon 60D |
| --- | --- |
| Sensor | 18MP APS-C (cukup untuk cetak saiz A3) |
| Burst | 5.3fps (cukup untuk event) |
| Skrin | Vari-angle (kegemaran jurukamera Malaysia) |
...
## 5 gig yang 60D + 50mm boleh menang

| Gig | Bayaran | Kenapa 60D sesuai |
| --- | --- | --- |
| Konvokesyen | RM200-450 | Tempoh pendek, subjek statik |
| Mini session potret | RM150-400 | 50mm f/1.8 memang lens potret |
| Produk Shopee/Lazada | RM200-500 | Tripod + manual focus, AF tak perlu |
| Makanan cafe/kopitiam | RM150-400 | Kit lens + cahaya tingkap |
| Event kecil | RM300-600 | Flash luaran RM180 je |

## Berapa job nak bayar gear seterusnya

| Gear sasaran (terpakai) | Harga | Jumlah job |
| --- | --- | --- |
...
- **Mode:** M (Manual) untuk kawalan penuh.
- **ISO:** cap pada 1600, boleh 3200 jika terpaksa.
- **AF:** One-Shot, Single Point.
- **File:** RAW + JPG. Edit dalam Lightroom mobile percuma atau RawTherapee (PC).
- **Flash:** bounce ke siling, bukan flash terus.
