...
| Pakej | Bayaran | Isi |
| --- | --- | --- |
| 5 produk | RM200-300 | 20-30 gambar total |
| 10 produk | RM350-500 | 40-60 gambar + edit |
| 20 produk | RM600-900 | 80-120 gambar, 2 latar |
| Video 15 saat per produk | +RM50-100 | Bonus listing |

Purata pasaran: **RM200-500** untuk pakej 5-10 produk.

## Contoh job sebenar (localised)

**Pakej 10 produk untuk seller skincare di Shah Alam.** Puan Sarah jual serum dan krim muka di Shopee, 10 produk, gambar semasa "biasa-biasa".

- Bayaran: **RM400** (10 produk, 50 gambar + video 15 saat untuk 3 produk terlaris)
- Setup: meja dapur, kertas putih, lampu LED RM150 + cahaya tingkap
- Teknik: tripod, manual focus, bukaan f/5.6, remote shutter
- Deliver: 4 hari, warna konsisten, latar bersih
- Hasil: listing Puan Sarah naik jualan, dia booking 15 produk lagi sebulan kemudian

RM400 pakej pertama anda = flash + tripod + lampu dan lebih.

## Berapa job nak bayar gear

| Gear sasaran | Harga | Jumlah pakej (RM350 avg) |
| --- | --- | --- |
| Lampu LED + tripod + kertas | ~RM300 | 1 pakej |
| Sony A6100 terpakai | ~RM1,800 | 5-6 pakej |
| Sigma 18-50mm f/2.8 | ~RM2,500 | 7-8 pakej |
| Godox SL150III | ~RM800 | 2-3 pakej |
...
- (Pilihan) GIMP/Photopea percuma untuk buang latar
