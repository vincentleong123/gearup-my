...
description: >-
  Anda tak perlu kamera untuk mula dalam industri ini: gig editing dan retouch
  untuk jurugambar lain membayar RM50-300 satu pakej. Ini jalan masuk kos sifar
  yang membayar gear pertama anda.
...
1. Terima 50-200 gambar mentah dari jurugambar (biasanya satu majlis/event).
2. Edit: crop, luruskan, perbetul warna, terangkan, skin retouch ringan.
3. Hantar gambar siap dalam 3-5 hari (cakap awal berapa lama).
4. Guna Lightroom (percuma di telefon, atau RM35/bulan) atau RawTherapee (percuma).

## How much: berapa bayaran di Malaysia

| Jenis kerja | Bayaran | Isi |
| --- | --- | --- |
| Pakej konvokesyen (20-30 gambar) | RM50-100 | Edit ringan, warna, crop |
| Pakej wedding (100-200 gambar) | RM150-300 | Edit penuh + retouch |
| Retouch portrait per gambar | RM5-20/gambar | Skin, mata, objek buang |
| Backup editor (bulanan) | RM300-600 | Kerja tetap dari 1-2 jurugambar |

## Contoh job sebenar

**Contoh A:** Jurugambar konvokesyen di KL ada 5 majlis sebulan dan tak sempat edit. Anda tawarkan RM80 satu pakej (30 gambar). Dia hantar 3 pakej sebulan = RM240 pendapatan sampingan, dari rumah, tanpa keluar.

**Contoh B:** Anda cari jurugambar wedding di Instagram, tawarkan edit 50 gambar percuma sebagai ujian. Dia puas hati, mula hantar kerja tetap RM250 satu majlis, 2-3 majlis sebulan = RM500-750 sebulan.
...
| Gear sasaran | Harga | Bilangan pakej edit |
| --- | --- | --- |
| Mic lapel (jika mahu video) | ~RM50 | 1 pakej |
| Flash luaran | ~RM180 | 2-3 pakej |
| Sony A6100 terpakai | ~RM1,800 | 20-30 pakej wedding |
| Sigma 18-50mm f/2.8 | ~RM2,500 | 30-40 pakej |
