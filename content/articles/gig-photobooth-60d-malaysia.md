...
1. Setup photobooth: backdrop, lampu, kamera pada tripod.
2. Tetamu datang, ambil gambar (anda atau remote shutter).
3. Print-on-site (jika ada printer) atau hantar gambar dalam 24 jam.
4. Bungkus dan bersih selepas majlis.

## How much: berapa bayaran di Malaysia

| Pakej | Bayaran | Isi |
| --- | --- | --- |
| Basic (kamera + prop, tanpa print) | RM300-500 | Gambar digital, 3-4 jam |
| Dengan printer instant | RM500-800 | Print on-site + digital |
| Premium (backdrop + lighting + prop) | RM800-1,200 | Full setup, print, background |
...
| Gear sasaran | Harga | Bilangan gig photobooth |
| --- | --- | --- |
| Backdrop + printer sewa | ~RM100 | 1 gig |
| Printer instant (Canon Selphy) | ~RM800 | 2-3 gig premium |
| Godox SL150III | ~RM1,200 | 2-3 gig premium |
| Sony A6100 terpakai | ~RM1,800 | 4-5 gig |
