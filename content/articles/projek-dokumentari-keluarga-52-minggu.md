...
imageCuration:
  - caption: Anak lelaki dewasa merakam ayah yang tersenyum sambil membuat kerja rumah, cahaya petang
    context: Rumah keluarga
    purpose: hero
    position: Selepas intro
    alt: Merakam ayah di rumah
    credit: Unsplash
    sourceUrl: https://images.unsplash.com/photo-1500375592092-40eb2168fd21?w=1200&h=630&fit=crop
    aspectRatio: 16/9
...
Tahun depan, ayah kau akan jadi setahun lebih tua. Dua tahun lagi, setahun lagi tua. Bunyi macam jelas, tapi kita tak hidup macam tu.
...
Sekali sebulan, duduk 10 minit, buka voice recorder telefon, dan tanya 5 soalan ini:

1. *"Masa kecik, kau nak jadi apa?"*
2. *"Cerita pasal satu hari paling bahagia dalam hidup kau."*
3. *"Satu nasihat yang kau nak bagi masa muda dulu?"*
4. *"Macam mana kau jumpa mak/ayah kau?"*
5. *"Kalau boleh balik, apa yang kau buat lain?"*
...
## Teknik mudah supaya rakaman nampak layak disimpan
...
**Sistem simpanan (5 minit):**
- Folder utama: `Keluarga 2026`
- Sub-folder per bulan: `01-Januari`, `02-Februari`...
- Rakaman suara: folder `Suara` dengan tarikh dalam nama fail
...
## Kalau kau cuma ada masa 10 minit bulan ini
