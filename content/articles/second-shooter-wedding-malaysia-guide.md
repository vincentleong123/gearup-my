...
imageCuration:
  - caption: Photographer di majlis perkahwinan Malaysia dengan dua kamera â€” satu body di tangan, satu di strap, mengikuti pengantin
    ...
    alt: Second shooter di majlis kahwin
    credit: Unsplash
    sourceUrl: https://images.unsplash.com/photo-1583939003579-730e3918a45a?w=1200&h=630&fit=crop
    aspectRatio: 16/9
    notes: Ganti dengan foto majlis kahwin tempatan bila ada
    active: true
  - caption: Dua kamera dengan lens f/1.8 dan kad memori sandaran di atas meja majlis
    context: Persediaan sebelum majlis
    purpose: spec-detail
...
## Gear minimum: tak perlu dua body

Ini perkara yang ramai salah faham. Kau **tak perlu** kamera mahal untuk jadi second shooter. Yang perlu:
...
## Etika yang menentukan dipanggil lagi

Ini yang memisahkan second shooter yang naik pangkat dengan yang hilang:

- **Jangan poach client.** Semua gambar majlis = hasil main photographer. Jangan WhatsApp pengantin tawarkan diri.
- **Hantar RAW/gambar penuh pada masa yang dijanjikan.** Main shooter nak edit sendiri. Lewat = kau tak dipanggil lagi.
- **Berdiri di mana disuruh.** Ada saat yang kau kena senyap dan tak menghalang. Baca arahan.
- **Jangan post sebelum main shooter post.** Kadang-kadang client tak nak content awal. Tanya dulu.
- **Dress code.** Photographer wedding berpakaian kemas (biasanya hitam). Bukan baju t-shirt untuk client shoot.
- **Bawa air dan siap awal.** 12 jam. Datang 30 minit awal = reputasi.

[IMAGE CURATION #2]

## Rate: berapa kau patut caj

Pasaran Malaysia (anggaran semasa):
...
> Panduan ini ilustrasi untuk perancangan kerjaya berdasarkan amalan industri Malaysia biasa. Kadar gig, harga gear dan permintaan berbeza mengikut masa, tempat dan portfolio individu.
