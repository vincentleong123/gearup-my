...
export const metadata: Metadata = {
  title: 'Camera Reviews & Content Creation Guides Malaysia | GearUp Blog',
  ...
  openGraph: { title: 'Reviews & Guides — GearUp Malaysia', description: 'Guides, gear comparisons, and inspiration for Malaysian content creators.' },
  alternates: { canonical: 'https://gearup.my/blog' },
};
