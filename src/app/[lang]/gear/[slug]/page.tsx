    ...
    <>
      ...
      <article className="min-h-screen pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* How to pay it off */}
          <PayoffPath gear={gear} lang={lang} />
          ...
          {gear.usedTip && (
            <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-6 mb-10">
              ...
              <Link
                href={withLang(lang, '/blog/used-camera-buying-guide-malaysia-mudah-carousell')}
          ...
          {/* Hashtag bank */}
          <HashtagBank gearSlug={gear.slug} gearName={gear.name} lang={lang} />
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {relatedCreators.map(c => (
                  <Link key={c.slug} href={withLang(lang, `/creators/${c.slug}`)} className="block bg-zinc-900/60 border border-zinc-800 rounded-xl p-5 hover:border-cyan-500/30 hover:-translate-y-0.5 transition-all group">
          ...
          {relatedGear.length > 0 && (
            <div className="mb-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href={withLang(lang, '/compare')} className="text-sm text-zinc-200 hover:text-white font-semibold transition-colors">
                  Open Compare tool →
                </Link>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                {relatedGear.map(g => (
                  <Link key={g.slug} href={withLang(lang, `/gear/${g.slug}`)} className="group block bg-zinc-900/60 border border-zinc-800 rounded-xl overflow-hidden hover:border-red-500/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-red-500/5 transition-all">
