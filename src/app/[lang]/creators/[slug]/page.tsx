...
export default async function CreatorPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    '@type': 'Person',
    name: creator.name,
    description: `Illustrative ${creator.niche} content creator journey in Malaysia, modelled on typical Malaysian gig rates of around RM${creator.monthlyEarningsMin.toLocaleString()}+ per month. Fictional, not a real individual.`,
    knowsAbout: creator.gear,
    mainEntityOfPage: { '@type': 'WebPage', '@id': `${BASE_URL}${withLang(lang, `/creators/${creator.slug}`)}` },
  };
