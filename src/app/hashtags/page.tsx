...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://kameralog.com/hashtags' },
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-1.5 text-sm text-cyan-400 font-semibold mb-4">
              🏷️ Hashtag Glossary — curated on-site, no out-clicks
            </div>
            <h1 className="text-4xl md:text-6xl font-black mb-4">
              Search Gear Hashtags, <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-pink-400 to-fuchsia-400">Keep Content Here</span>
            </h1>
            <p className="text-zinc-200 max-w-2xl mx-auto text-lg">
              Type a hashtag like <span className="font-bold text-cyan-300">#DJIOSMO</span> or{' '}
              <span className="font-bold text-cyan-300">#IPHONE17PRO</span> and get a curated library of settings recipes,
              gear reviews, and the exact part-time gigs that pay the gear off. All on your site — no Instagram hopping.
            </p>
          </div>
