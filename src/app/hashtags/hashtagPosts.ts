...
export const hashtagPosts: HashPost[] = [
  ...
  buildPost(
    ...
    'Under 250g so no CAAM license needed. Clients pay RM300-600 per property for a crisp aerial reveal, orbit and fly-through.',
    [
      'Under 250g = fly commercially same-day',
      '4K 60fps aerial',
  ...
  buildPost(
    ...
    'The no-license Mini with 4K 120fps slow motion. Smooth sunsets, event reveals and travel b-roll that makes clients say "whoa".',
    [
      '4K 120fps slow-mo aerial',
      '50MP stills for listings',
      'ActiveTrack follow mode',
      'No CAAM license needed',
    ],
