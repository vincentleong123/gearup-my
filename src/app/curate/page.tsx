        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-red-500/10 border border-red-500/20 rounded-full px-4 py-1.5 text-sm text-red-400 font-semibold mb-5">
              🔴 LIVE · auto-curated from the web
            </div>
          ...
          {/* Hashtag bank */}
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-3">#️⃣ The hashtag bank</h2>
            <p className="text-zinc-500 text-sm mb-5">One-click mining. Open any tag on Instagram or TikTok and study the top posts.</p>
          ...
          <div className="mt-12 bg-gradient-to-br from-red-500/10 to-pink-500/5 border border-red-500/20 rounded-3xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/gigs" className="inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-red-500 to-pink-600 text-white font-bold rounded-xl hover:shadow-xl hover:shadow-red-500/25 transition-all">
                💰 Explore the Gigs Hub
              </Link>
              <Link href="/quiz" className="inline-flex items-center gap-2 px-7 py-3.5 bg-zinc-800/50 text-white font-bold rounded-xl border border-zinc-700/50 hover:bg-zinc-800 transition-all">
                🎯 Gear Match Quiz
              </Link>
            </div>
          </div>
