        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-5 gap-6 mb-10">
            <div className="md:col-span-3 bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {starterGear.map(g => (
                  <Link key={g.slug} href={`/gear/${g.slug}`} className="flex items-center gap-3 bg-zinc-900/70 border border-zinc-800 rounded-xl p-3 hover:border-amber-500/40 transition-all group">
              ...
              {upgradeGear.length > 0 && (
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {upgradeGear.map(g => (
                      <Link key={g.slug} href={`/gear/${g.slug}`} className="text-xs text-amber-400/90 bg-amber-500/5 border border-amber-500/20 px-2.5 py-1.5 rounded-lg hover:bg-amber-500/10 transition-colors">
            ...
            <div className="md:col-span-2 bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 flex flex-col">
              ...
              <Link href={`/gear${cheapestStarter ? '/' + cheapestStarter.slug : ''}`} className="mt-4 inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-amber-400 to-yellow-500 text-zinc-950 font-bold rounded-xl text-sm hover:shadow-lg hover:shadow-amber-500/25 transition-all">
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {relatedArticles.map(a => (
                  <Link key={a.slug} href={`/blog/${a.slug}`} className="block bg-zinc-900/60 border border-zinc-800 rounded-xl p-5 hover:border-amber-500/40 transition-all group">
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-yellow-500/5 border border-amber-500/20 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link href="/curate" className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800/50 text-white font-bold rounded-xl border border-zinc-700/50 hover:bg-zinc-800 transition-all">
