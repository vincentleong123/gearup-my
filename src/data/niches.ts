...
export const niches: Niche[] = [
  ...
  },
  {
    ...
    earningPotential: 'RM 2,000 – 6,000/month',
    tips: [
      'Chest or suction mount for driving POV — GoPro or Osmo Action is ideal',
      'Review affordable cars first: Myvi, Axia, Saga — these get the most searches',
      'Film walkaround + interior + driving in one take — keep it natural',
      'Include real fuel consumption data — Malaysians care about "minyak"',
      'Drone shots of the car driving = instant production value upgrade',
      'Offer "review your car" service for RM200 — start with friends and family',
    ],
    contentIdeas: [
      'Myvi 2026 review — masih power kah?',
      'First car under RM30,000 — which one to buy?',
      'Proton vs Perodua — the ultimate comparison',
      'Modding my [car] on a budget of RM1,000',
      'Used car buying guide: what to check before beli',
    ],
  },
  {
    slug: 'daily-vlog',
